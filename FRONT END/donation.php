...
<body>
    ...
    <br>
    <div class="form" style="height:550px; margin-top:340px;">
    ...
    <br>
        <!-- Input For Add Values To Database-->
                ...
                <!-- Input For Find Values With The given ID -->
                <center><button class="b1"><a href="donationdisplay.php">View All</a></button></center>
    </form>
    </div>
            
    <footer style="margin-top:590px;"></footer>
</body>
</html>